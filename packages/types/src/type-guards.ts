...
/**
 * Check whether a given value is an {@link @dva/types#ITeam}
...
/**
 * Check whether a given value is an {@link @dva/types#IChannel}
 * @param arg - value to check
 * @beta
 */
...
/**
 * Check whether a given value is an {@link @dva/types#IMessage}
 * @param arg - value to check
 * @beta
 */
